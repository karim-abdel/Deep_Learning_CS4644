...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.i2hid = nn.Linear(input_size + hidden_size, hidden_size)

        # initialize block that creates output
        self.i2out = nn.Linear(input_size + hidden_size, output_size)
    ...
    def forward(self, input, hidden):
        ...
        hid = self.i2hid(concat)
        out = self.i2out(concat)
        output = self.soft(out)
        hidden = self.tan(hid)
