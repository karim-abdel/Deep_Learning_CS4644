...
def style_transfer(
    ...
    axs[0].axis("off")
    axs[1].axis("off")
    axs[0].set_title("Content Source Img.")
    axs[1].set_title("Style Source Img.")
    axs[0].imshow(deprocess(content_img.cpu()))
    axs[1].imshow(deprocess(style_img.cpu()))
    ...
    axs[2].axis("off")
    axs[2].set_title("Final Img.")
    axs[2].imshow(deprocess(img.cpu()))
    return plt
